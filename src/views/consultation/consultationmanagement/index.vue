    ...
    <el-card class="box-card">
      ...
      <div>
        <el-form ref="ruleForm" :model="ruleForm" label-width="75px">
          ...
          <el-form-item label="主治医师:" prop="realName">
    ...
    <div class="tablemain">
      ...
      >
        ...
        <el-table-column prop="address" label="操作" min-width="150" align="center">
          <template slot-scope="scope">
            <el-button type="primary" @click="consultationDetail(scope.row)" size="mini">团队详情</el-button>
            <el-button type="primary" @click="storeConsultDetail(scope.row.id)" size="mini">会诊订单</el-button>
            <el-button type="primary" @click="consultationRemark(scope.row)" size="mini">团队备注</el-button>
        ...
        <div class="">
          ...
          >
            ...
            <el-table-column prop="address" label="操作" min-width="100" align="center">
              <template slot-scope="scope">
                <el-button type="primary" @click="seedetailtdxq(scope.row)" size="mini">查看</el-button>
              </template>
            </el-table-column>
