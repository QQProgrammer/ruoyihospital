<template>
  <div class="everypage">
    ...
    <!-- 列表表格 -->
    <div class="tablemain">
      <!-- <el-button type="primary" icon="el-icon-plus" disabled="disabled" class="tabledeletebtn" @click="add" size="mini">新增医护</el-button> -->
      <el-table
        class="tablecss"
        ref="multipleTable"
        v-loading="loading"
      ...
      >
        ...
        <el-table-column prop="jobTitle" label="职称" width="95" align="center">
        ...
        <el-table-column prop="" label="操作" width="200" align="center">
          <template slot-scope="scope">
            ...
            <!-- <el-button type="primary" @click="edit(scope.row)" disabled="disabled" size="mini">编辑</el-button> -->
