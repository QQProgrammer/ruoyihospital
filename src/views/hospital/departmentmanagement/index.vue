  ...
  <div class="everypage">
    ...
    <el-card class="box-card">
      ...
      <div>
        <el-form ref="ruleForm" :model="ruleForm" :inline="true" label-width="75px">
          <el-form-item label label="科室筛选" prop="id">
            <el-select v-model="ruleForm.id" size="mini" clearable placeholder="请选择">
            <el-option
              v-for="item in allHospDeptList"
              :key="item.id"
              :label="item.deptName"
              :value="item.id">
            </el-option>
    ...
    <div class="tablemain">
      ...
      >
        ...
        <el-table-column prop="hospCode" label="科室编码"min-width="50" align="center"></el-table-column>
        ...
        <el-table-column prop="memSize" label="内存空间" min-width="52" align="center"></el-table-column>
        <el-table-column prop="memUsed" label="已使用内存空间" min-width="52" align="center"></el-table-column>
        ...
        <el-table-column prop="addTime" label="添加时间" min-width="52" align="center"></el-table-column>
    ...
    <el-dialog class="ruleselform" :title="title" :visible.sync="dialogAddFormVisible">
      <el-form :model="form" :rules="rules" ref="form" label-width="120px">
        ...
        <el-form-item label="科室简介" prop="deptInfo">
          <el-input v-model="form.deptInfo" type="textarea" :rows="2"  placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="科室编号" prop="hospCode">
          <el-input v-model="form.hospCode" type="textarea" :rows="2"  placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="门诊地址信息" prop="clinicInfo">
          <el-input v-model="form.clinicInfo" type="textarea" :rows="2" placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="病房地址信息" prop="roomInfo">
          ...
          <div class="">
            ...
            >
              ...
              <el-table-column prop="" label="操作" min-width="52" align="center">
                <template slot-scope="scope">
                  <el-button type="primary" @click="setLoginPC(scope.row)" size="mini">设为可登陆PC管理端</el-button>
                </template>
              </el-table-column>
            </el-table>
          </div>
          ...
          <div class="">
            <el-table
              ...
              <el-table-column prop="" label="操作" min-width="70" align="center">
                <template slot-scope="scope">
                  <el-button v-if="scope.row.isManager == 0" type="primary" @click="setAdministrator(scope.row)" size="mini">设为管理员</el-button>
                  <el-button v-if="scope.row.isManager == 1" type="primary" @click="cancelAdministrator(scope.row)" size="mini">取消管理员</el-button>
                  <el-button type="primary" @click="seedetailtdxq(scope.row)" size="mini">查看医生信息</el-button>
                </template>
              </el-table-column>
            </el-table>
            <el-pagination
...
<script>
import {selectAllHospDepts} from "@/api/hospital/hospitalmanagement";
