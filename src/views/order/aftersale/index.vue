...
<!-- 
 ...
 -->
  <div class="everypage">
    ...
    <div class="tablemain">
      <el-button type="primary" class="tabledeletebtn" @click="deleteallserve" size="mini">批量删除订单</el-button>
      <el-table
        class="tablecss"
        ref="multipleTable"
        v-loading="loading"
      ...
      >
        ...
        <el-table-column prop="serviceScore" label="评价分数" min-width="52" align="center"></el-table-column>
        <el-table-column prop="serviceName" label="评价服务" min-width="52" align="center"></el-table-column>
        ...
        <el-table-column prop label="操作" min-width="100" align="center">
          <template slot-scope="scope">
            <el-button type="primary" @click="seedetail(scope.row)"  size="mini">查看</el-button>
            <el-button type="primary" @click="OrderRemark(scope.row)" size="mini">回复</el-button>
            <el-button type="primary" @click="deleteservelist(scope.row.orderId)" size="mini">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
        ...
        <div class="twocolumn">
          ...
          <div class="twocolumnlist">
            ...
            <div>
              ...
              <p>标签印象：{{typeObj.commentTag}}</p>
            </div>
            <div>
              <p>评价服务：{{typeObj.serviceName}}</p>
            ...
            <div>
              <p style="display:flex">
                <span>评价图片：</span>
                <img v-if="typeObj.pics" :src="typeObj.pics" :key="index" style="width:200px;height:200px;object-fit: scale-down;">
