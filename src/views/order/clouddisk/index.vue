...
<!-- 
 ...
 -->
  <div class="everypage">
    ...
    <div class="tablemain">
      <el-button class="tabledeletebtn" @click="deleteallserve" type="primary" size="mini">批量删除订单</el-button>
      <el-table
        class="tablecss"
        ref="multipleTable"
        v-loading="loading"
...
<!--        <el-table-column prop="orderState" label="订单状态" width="76" align="center"></el-table-column>-->
        <el-table-column prop="addTime" label="下单时间" min-width="60" align="center"></el-table-column>
        <el-table-column prop label="操作" width="200" align="center">
          <template slot-scope="scope" align="center">
            <el-button type="primary" @click="clouddiskDetail(scope.row.orderId)" size="mini">订单详情</el-button>
            <el-button type="primary" @click="clouddiskRemark(scope.row)" size="mini">订单备注</el-button>
...
<!--            <div>-->
<!--              <p>订单状态：{{clouddiskDetaillist.orderState}}</p>-->
<!--            </div>-->
          </div>
        </div>
        <div class="twocolumn">
