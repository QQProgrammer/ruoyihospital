...
<!--        </el-table-column>-->
        ...
        <el-table-column prop label="操作" width="200" align="center">
          <template slot-scope="scope">
            <el-button type="primary" @click="paymentDetail(scope.row.orderId)" size="mini">订单详情</el-button>
            <el-button type="primary" @click="paymentRemark(scope.row)" size="mini">订单备注</el-button>
