...
<!--
 ...
 -->
  <div class="everypage">
    ...
    <!-- 列表表格 -->
    <div class="tablemain">
      <el-button class="tabledeletebtn" type="primary" @click="deleteallserve" size="mini">批量删除订单</el-button>
      <el-table
        class="tablecss"
        ref="multipleTable"
        v-loading="loading"
      ...
      >
        ...
        <el-table-column prop label="操作" min-width="110" align="center">
          <template slot-scope="scope">
            <el-button type="primary" @click="serviceDetail(scope.row.orderId)" size="mini">订单详情</el-button>
            <el-button type="primary" v-if="scope.row.orderState == -1" @click="chargeback(scope.row.orderId)" size="mini">退单</el-button>
            <el-button type="primary" @click="OrderRemark(scope.row)" size="mini">订单备注</el-button>
